...
with mic as fonte:
    ...
    try:
        ...
        if (text == "Sexta-Feira" or text == "Sexta-Feira, tá aí"):
          print("Olá, chefe.")
        elif(text == "reiniciar" or text == "Sexta-Feira reiniciar"):
         print('Reiniciando seu computador...')
         os.system("shutdown /r /t 1")
        elif (text == "abrir meus aplicativos"):
          pyautogui.press('win')
          pyautogui.write('skype')
          pyautogui.press('enter')
        elif(text == "verificar site de arquitetura"):
         ...
         if(urllib.request.urlopen("https://agaempreendimentos.com.br").getcode() == 200):
          ...
          print("Não entendi esse comando, chefe.")
